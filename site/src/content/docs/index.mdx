...
<Aside type="tip" title="Verified interop, not just a claim">
Three independent SDKs — Go, Python, TypeScript — verify each other's receipts against a shared Ed25519 keypair, across a positive corpus and a MUST-reject corpus, on every push. See [Conformance](/conformance/) for the results matrix and commit-pinned vectors.
</Aside>
...
- [Conformance](/conformance/) — cross-language SDK interop verified against a shared corpus, CI-enforced
