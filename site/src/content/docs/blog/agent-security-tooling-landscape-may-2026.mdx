...
ogImage: /og-blog-landscape-may-2026.png
head:
  - tag: link
    attrs:
      rel: canonical
...
> **This is an older snapshot.** The most recent landscape read is [June 2026](/blog/agent-security-tooling-landscape-june-2026/), and the always-current view lives at the [landscape document](/ecosystem/landscape/). Read those for where the space is now; this post preserves our May framing.
